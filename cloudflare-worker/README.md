...
1. Fork 本仓库。
2. [点击下载：步骤1-一键安装脚本](https://github.com/loqwe/heyun-zjmf-worker-monitor/releases/download/release-step1-bat-v1/步骤1-一键安装脚本.bat)，保存到你想部署的目录。
   这是 Release 附件下载链接，点击后会下载 `步骤1-一键安装脚本.bat`。
